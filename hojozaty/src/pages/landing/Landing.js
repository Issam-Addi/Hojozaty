            ...
            <div className="relative w-full h-full flex justify-end bg-gradient-to-t from-black via-transparent to-black overflow-hidden">
                ...
                <div className="relative py-28 xl:py-40 w-full md:w-2/3 lg:w-1/2 h-full flex flex-col justify-center">
                    ...
                    <div className="mx-5 md:mx-0 p-8 rounded-xl md:rounded-r-none bg-gray-800 bg-opacity-50 text-white shadow-2xl">
                        <h1 className="text-3xl sm:text-5xl font-josefin font-extrabold">Hojozaty, <br /><span className="text-yellow-400 text-opacity-80">Fancy Hero 8</span> est <br />Formidable !</h1>
                ...
                <div className="grid gap-6 row-gap-5 lg:grid-cols-3">
                    <div className="border rounded-xl" >
                        <img className="object-cover w-full h-64 mb-6 rounded-xl shadow-lg lg:h-80 xl:h-96"
                            src="https://content.joacademy.com/images/%D9%85%D8%AF%D9%8A%D9%86%D8%A9%20%D9%85%D8%B9%D8%A7%D9%86_1654181692.jpg"
                            alt="maan image" />
                        <h5 className="mb-2 ml-2 text-xl font-bold leading-none sm:text-2xl">
                            Maan city
                        </h5>
                        <p className="text-gray-700 ml-2">
                            About the city: O for awesome, this chocka full cuzzie is as rip-off as a cracker Meanwhile, in behind the bicycle shed, Hercules Morse.
                        </p>
                        <Link to="maan">
                            <button
                    ...
                    <div className="border rounded-xl" >
                        <img className="object-cover w-full h-64 mb-6 rounded-xl shadow-lg lg:h-80 xl:h-96"
                            src="https://img.alwakeelnews.com/Content/Upload/med/520222816377591226578.jpg"
                            alt="Az-zarqa image" />
                        <h5 className="mb-2 ml-2 text-xl font-bold leading-none sm:text-2xl">
                            Az-zarqa city
                        </h5>
                    ...
                    <div className="border rounded-xl" >
                        <img className="object-cover w-full h-64 mb-6 rounded-xl shadow-lg lg:h-80 xl:h-96"
                            src="https://alshareet.net/assets/2021-02-17/images/26601_3_1613526035.jpg"
                            alt="Jerash image" />
                        <h5 className="mb-2 ml-2 text-xl font-bold leading-none sm:text-2xl">
                            Jerash city
                        </h5>
                    ...
                    <div className="border rounded-xl" >
                        <img className="object-cover w-full h-64 mb-6 rounded-xl shadow-lg lg:h-80 xl:h-96"
                            src="https://pbs.twimg.com/media/EUDzRPiWsAImnFJ.jpg"
                            alt="Irbid image" />
                        <h5 className="mb-2 ml-2 text-xl font-bold leading-none sm:text-2xl">
                            Irbid city
                        </h5>

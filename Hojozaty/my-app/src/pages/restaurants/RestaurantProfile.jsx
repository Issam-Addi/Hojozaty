                        ...
                        <div className="flex flex-wrap border shadow rounded-lg p-3 dark:bg-gray-600">
                          ...
                          <div className="flex flex-col gap-2 w-full border-gray-400">
                            ...
                            <div>
                              ...
                              <select class="w-full h-10 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-amber-500 md:px-3 py-0 md:py-1 tracking-wider" id="food_type" onChange={(e) => {

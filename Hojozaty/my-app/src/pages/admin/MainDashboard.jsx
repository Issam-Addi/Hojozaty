  ...
  return (
    <div className='bg-white'>
      ...
      <div className="md:mt-14 mt-4 relative sm:flex items-center justify-center">
        ...
        <div className="p-6 w-56 bg-amber-600 rounded-lg absolute z-20 left-0 xl:ml-56 -mt-40">
        ...
        <div className="p-6 w-56 bg-amber-600 rounded-lg absolute z-20 mt-80 -ml-0 ">
          <p className="text-3xl font-semibold text-black">8K+</p>
          <p className="text-base leading-4 xl:mt-4 mt-2 text-black">
            Active Listening
          </p>
        </div>
        <div className="p-6 w-56 bg-amber-600 rounded-lg absolute z-20 md:mt-0 sm:-mt-5 mt-4 right-0 xl:mr-56 sm:mr-24">

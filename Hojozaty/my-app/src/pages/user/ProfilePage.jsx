        ...
        <>
            <div className="bg-white mt-16 max-w-screen-xl mx-auto pt-5 px-4">
                ...
                <h1 className="md:text-4xl text-2xl font-bold leading-tight mb-2 pb-4 relative">
                    <span className="bg-clip-text text-transparent bg-amber-400 uppercase">My Profile</span>
                ...
                <div className="p-8 bg-gray-200 shadow-xl mt-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3">
                        ...
                        <div className="relative">
                            <div className="w-48 h-48 bg-amber-400 mx-auto rounded-full shadow-2xl absolute inset-x-0 top-0 -mt-16 md:-mt-24 flex items-center justify-center">
                                <svg
                    ...
                    <div className="mt-28 text-center border-b pt-12">
                        ...
                        <div className="space-x-8 flex justify-center md:justify-center">
                            <Link to="/EditProfile" className="text-white py-2 px-4 rounded-xl border border-amber-400 bg-amber-400 hover:shadow-xl hover:bg-transparent hover:text-amber-400 transform hover:-translate-y-1 transition">
                                Edit Profile
                            </Link>
                        </div>
                    </div>
                ...
                <h1 className="md:text-4xl text-2xl font-bold text-gray-900 leading-tight mb-2 pb-4 relative">
                    <span className="bg-clip-text text-transparent bg-gradient-to-r from-amber-400 to-amber-400 uppercase">Previous reservations</span>
                    <span className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-amber-400 to-amber-400"></span>
                </h1>
                                    ...
                                    <>
                                        <div className="rounded-lg overflow-hidden shadow-xl">
                                            <div className="relative">
                                                ...
                                                <div className="absolute bottom-0 left-0 bg-amber-400 px-4 py-2 text-white text-sm font-bold">
                                                    {order.status}
                                                </div>
                                                <div className="absolute top-0 right-0 bg-amber-400 px-4 text-white rounded-full h-16 w-16 flex flex-col items-center justify-center mt-3 mr-3">
                                                    <span>Order</span>
                                                    {order.orders_id}
                                                </div>
                                            </div>

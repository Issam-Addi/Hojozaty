...
const ProfilePage = () => {
    ...
    const userId = JSON.parse(localStorage?.getItem('curruntUser'));
    ...
    useEffect(() => {
        axios.get(`http://localhost:5000/user/${userId.userid}`)
        ...
        axios.get(`http://localhost:5000/userOrders/${userId.userid}`)
            .then(function (response) {
        ...
        axios.get(`http://localhost:5000/oldOrders/${userId.userid}`)
            .then(function (response) {

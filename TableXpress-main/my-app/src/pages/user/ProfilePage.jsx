        ...
        <>
            <div className="p-16 bg-white">
                <h1 className="text-4xl font-bold text-gray-900 leading-tight mb-2 pb-4 relative">
                    <span className="uppercase text-orange-900">My Profile</span>
                    <span className="absolute bottom-0 left-0 w-full h-1 bg-orange-900"></span>
                </h1>
                ...
                <div className="p-8 bg-white shadow mt-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3">
                        ...
                        <div className="relative">
                            {" "}
                            <div className="w-48 h-48 bg-orange-900 mx-auto rounded-full shadow-2xl absolute inset-x-0 -mt-24 lg:top-0 flex items-center justify-center top-7">
                                <svg
                    ...
                    {user.length !== 0 &&
                        ...
                        <div className="mt-20 text-center border-b pb-12">
                            ...
                            <div className="space-x-8 flex justify-center mt-20 md:mt-10 md:justify-center">
                                <Link to="/EditProfile" className="py-2 px-4 uppercase rounded-lg text-white bg-orange-900 hover:bg-white hover:text-black border border-orange-900 shadow font-medium transition">
                                    Edit Profile
                                </Link>
                            </div>
                ...
                <h1 className="text-4xl font-bold text-gray-900 leading-tight mb-2 pb-4 relative">
                    <span className="uppercase text-orange-900">Current Reservations</span>
                    <span className="absolute bottom-0 left-0 w-full h-1 bg-orange-900"></span>
                    </h1>
                <div className="p-8 bg-white shadow mt-4">
                    {" "}
                ...
                <br /><br /><br />
                <h1 className="text-4xl font-bold text-gray-900 leading-tight mb-2 pb-4 relative">
                    <span className="uppercase text-orange-900">Previous Reservations</span>
                    <span className="absolute bottom-0 left-0 w-full h-1 bg-orange-900"></span>
                    </h1>
                <div className="p-8 bg-white shadow mt-4">
                    {" "}

  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage:'url("https://media.istockphoto.com/id/1416335096/photo/businessman-hand-holding-smart-phone-with-icon-mobile-phone-mail-telephone-and-address.jpg?b=1&s=170667a&w=0&k=20&c=O39_wq7HB2oZHV3pyeZDxFAq0Xb_zNvLKrAIEWDVveY=")'}}>
            ...
            <nav className="text-white mb-8">
              <ol className="list-none p-0 inline-flex">
                <li className="flex items-center">
                  <Link to="/" className="text-orange-900 hover:text-white transition">
                    Home
                  </Link>
                  <svg
        ...
        <div className="container mx-auto">
          <div className="mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full  lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0 mx-[60px]" >
                <h2 className="text-orange-900 mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                    <svg
                      ...
                      height={24}
                      viewBox="0 0 24 24"
                      className="fill-current text-orange-900">
                  ...
                  <div className="w-full">
                    <h4 className="text-orange-900 mb-1 text-xl font-bold">
                      Our Location
                    </h4>
                    <p className="text-body-color text-base">
                    Prince Naim S.t - Zarqa City , Jordan
                    </p>
                  </div>
                </div>
                ...
                <form method="post" onSubmit={handleSubmit}>
                  <div className="mb-6">
                    <input
                      ...
                      className="text-orange-900 w-full border border-black focus:border-orange-900 rounded py-3 px-[14px] text-base outline-none focus-visible:shadow-none shadow-md transition"
                      value={name}
                  ...
                  <div className="mb-6">
                    <textarea
                      ...
                      className="text-orange-900 border w-full resize-none rounded border-black focus:border-orange-900 py-3 px-[14px] text-base outline-none focus-visible:shadow-none shadow-md transition"
                      value={message}
                  ...
                  <div>
                    <button
                      type="submit"
                      className="bg-orange-900 border-orange-900 w-full rounded border p-3 text-white transition hover:bg-white hover:text-black">
                      Send Message
                    </button>
                  </div>
                </form>

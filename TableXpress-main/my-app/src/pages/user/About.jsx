...
function About() {
  ...
  return (
    <>
      ...
      <div
        className="bg-cover bg-center h-[400px] shadow"
        style={{
          backgroundImage:
      ...
      <div className="py-1 overflow-hidden mb-5">
        <div className="container m-auto px-6 space-y-8 md:px-12">
          <div>
            <h2 className="mt-14 text-2xl text-orange-900 text-center font-bold md:text-4xl">
              Main features
            </h2>
          </div>

          <div className="mt-16 grid border divide-x divide-y rounded-xl shadow-lg overflow-hidden sm:grid-cols-2 lg:divide-y-0 lg:grid-cols-3 xl:grid-cols-4">

            <div className="relative group bg-white hover:z-[1] hover:shadow-2xl hover:top-[-10px] hover:right-[-10px] transition rounded-lg">
              <div className="relative p-8 space-y-8">
                ...
                <div className="space-y-2">
                  <h5 className="text-xl font-medium transition group-hover:text-orange-900">
                    Several restaurants
                  </h5>
            ...
            <div className="relative group bg-white hover:z-[1] hover:shadow-2xl lg:hidden xl:block hover:top-[-10px] hover:right-[-10px] transition rounded-lg">
        ...
        <div className="-mx-7 flex flex-wrap items-center">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12 texy-black capitalize ">
              <div className="mt-10 lg:mt-0">
                <span className=" mb-2 block text-orange-900 text-lg font-semibold">
                  Why Choose Us
                </span>
                <h2 className="text-black mb-8 text-3xl font-bold sm:text-4xl">
                  {aboutUsData.about_title}
                </h2>
                <p className="text-body-color text-gray-600 mb-8 text-base">
